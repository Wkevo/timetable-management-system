...
<div align="center" style="margin-top: 20px">
    ...
    <button id="subjectmanual" class="btn btn-success btn-lg">ADD UNITS</button>
</div>
        ...
        <div class="modal-body" id="EnterSubject">
            ...
            <div style="display:none" id="addSubjectForm">
                <form action="addsubjectFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="subjectcode">Unit Code</label>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="subjectdepartment" name="SD">
                            ...
                            <option value="Education Technology in Computer Studies.">ETS</option>
                            <option value="Information System knowledge Management">SIK</option>
                        </select>
                    </div>
...
<div>
    ...
    <table id=subjectstable style="margin-left: 90px">
      ...
      <!--   <div class="item">
            <img  src="assets/img/Social/logo.jpg" alt="logo" class="center" style="TTMS\scode\assets\css\style.css">

        </div>
 -->
        <caption><strong> UNIT'S INFORMATION </strong></caption>
        <tr>

        ...
        <table border="2" cellspacing="3" align="center" id="timetable">
            <caption><strong><br><br>
                    ...
                    if (isset($_POST['select_semester'])) {
                        echo "MASINDE MULIRO UNIVERSITY OF SCIENCE AND TECHNOLOGY SEMESTER " . $_POST['select_semester'] . " ";
            ...
            <tr>
                ...
                <td style="text-align:center">7:00-10:00</td>
                <td style="text-align:center">10:00-1:00</td>
                <td style="text-align:center">1:00-4:00</td>
                <td style="text-align:center">4:00-7:00</td>
            ...
            <tr>
                ...
                <td style=\"text-align:center\">{$row['period3']}</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA MMUST TIMETABLE MANAGEMENT SYSTEM.";

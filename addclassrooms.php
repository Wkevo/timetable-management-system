...
<div align="center"
     style="margin-top:10%">
    <button
        id="classroommanual" class="btn btn-success btn-lg">ADD VENUE
    </button>
</div>
...
<div align="center">
    ...
    <table id=classroomstable>
        <caption><strong>ADDED VENUES</strong></caption>
        <tr>

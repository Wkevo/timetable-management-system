...
<div align="center" style="margin-top:20px">
    <button id="teachermanual" class="btn btn-success btn-lg">ADD LECTURER </button>
</div>
            ...
            <div style="display:none" id="addTeacherForm">
                <form action="addteacherFormValidation.php" method="POST">
                    <div class="form-group">
                        <label for="teachername">Lecturer's Name</label>
...
<div>
    ...
    <table id=teacherstable style="margin-left: 80px">
        <caption><strong> LECTURER'S INFORMAION </strong></caption>
        <tr>
